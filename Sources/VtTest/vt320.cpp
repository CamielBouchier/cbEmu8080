...
tst_vt320_device_status(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Device Status Reports (DSR)"));
...
tst_DECRPM(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("Request Mode (DECRQM)/Report Mode (DECRPM)"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_DECRQSS(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Status-String Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_cursor(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Cursor-Movement Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_report_terminal(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Terminal State Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_report_presentation(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Presentation State Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
...
tst_vt320_reports(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_PageFormat(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("Page Format Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_screen(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Screen-Display Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cbprintf("VT320 Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
