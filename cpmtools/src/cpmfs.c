...
// XXX CB : dir of executable.
CHAR ExePath[MAX_PATH];
GetModuleFileName(NULL, ExePath, MAX_PATH);
char* DiskDefFileName = strcat(dirname(ExePath), "\\diskdefs");

  d->type=0;
  // XXX CB if ((fp=fopen("diskdefs","r"))==(FILE*)0 && (fp=fopen(DISKDEFS,"r"))==(FILE*)0)
  if ( (fp=fopen(DiskDefFileName,"r")) == (FILE*)0)
  {
