...
class cb_Memory : public QObject
	{
    Q_OBJECT

	public:

		cb_Memory(const QString& ImageName);
	    ~cb_Memory();
...
inline uint8_t cb_Memory::Read(const uint16_t Address) 
    {
...
inline void cb_Memory::Write(const uint16_t Address,const uint8_t Data) 
    {
