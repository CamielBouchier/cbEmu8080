...
class cb_Console : public QObject 
    {
    Q_OBJECT
    ...
    private :
        ...
        cb_CharSet m_CharSets[c_NrHardCharSets + c_NrSoftCharSets];
        ...
        cb_ScreenCell* m_Cells; // #Columns*Row+Col.
        bool*         m_TabStops;
        cb_DWDH*       m_DWDHs;
...
inline int cb_Console::GetNrCols(const int Row) 
    {
...
inline void cb_Console::ResetDWDH(const int Row) 
    {
