 ...
 */
int
tst_DSR_locator(const char* the_title)
{
  return any_DSR(the_title, "?53n", show_Locator_Status);
}
...
/* vt340/vt420 & up */
int
tst_DSR_cursor(const char* the_title)
{
  return any_DSR(the_title, "?6n", show_ExtendedCursorPosition);
}

/******************************************************************************/

int
tst_vt320_device_status(const char*)
{
  /* *INDENT-OFF* */
  static MENU my_menu[] = {
      { "Exit",                                              0 },
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Device Status Reports (DSR)"));
...
int
any_decrqpsr(const char* the_title, int Ps)
{
  char *report;

  cup(1, 1);
  cb_printf("Testing DECRQPSR: %s\r\n", the_title);
...
static int
tst_DECCIR(const char* the_title)
{
  return any_decrqpsr(the_title, 1);
}

static int
tst_DECTABSR(const char* the_title)
{
  return any_decrqpsr(the_title, 2);
}

/* Test Window Report - VT340, VT420 */
static int
tst_DECRQDE(const char*)
{
  char *report;
  char chr;
...
static int
tst_DECRQUPSS(const char*)
{
  char *report;
  const char *show;

  __(cup(1, 1), println("Testing DECRQUPSS/DECAUPSS Window Report"));
...
int
any_RQM(const char* the_title, RQM_DATA * table, int tablesize, int Private)
{
  int j, row, Pa, Ps;
  char chr;
  char *report;
...
static int
tst_ISO_DECRPM(const char* the_title)
{
  /* *INDENT-OFF* */
  ...
  return any_RQM(the_title, ansi_modes, TABLESIZE(ansi_modes), 0);
}

static int
tst_DEC_DECRPM(const char* the_title)
{
  /* *INDENT-OFF* */
  ...
  return any_RQM(the_title, dec_modes, TABLESIZE(dec_modes), 1);
}
...
tst_DECRPM(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("Request Mode (DECRQM)/Report Mode (DECRPM)"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
static int
rpt_DECSASD(const char* the_title)
{
  return any_decrqss(the_title, "$}");
}

static int
rpt_DECSCA(const char* the_title)
{
  return any_decrqss(the_title, "\"q");
}

static int
rpt_DECSCL(const char* the_title)
{
  return any_decrqss(the_title, "\"p");
}

static int
rpt_DECSCPP(const char* the_title)
{
  return any_decrqss(the_title, "$|");
}

static int
rpt_DECSLPP(const char* the_title)
{
  return any_decrqss(the_title, "t");
}

static int
rpt_DECSSDT(const char* the_title)
{
  return any_decrqss(the_title, "$~");
}

int
rpt_DECSTBM(const char* the_title)
{
  return any_decrqss(the_title, "r");
}

static int
rpt_SGR(const char* the_title)
{
  return any_decrqss(the_title, "m");
}

static int
rpt_DECTLTC(const char* the_title)
{
  return any_decrqss(the_title, "'s");
}

static int
rpt_DECTTC(const char* the_title)
{
  return any_decrqss(the_title, "|");
}

int
tst_vt320_DECRQSS(const char*)
{
  /* *INDENT-OFF* */
  static MENU my_menu[] = {
      { "Exit",                                              0 },
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Status-String Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_cursor(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Cursor-Movement Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
static int
tst_vt320_report_terminal(const char*)
{
  /* *INDENT-OFF* */
  static MENU my_menu[] = {
      { "Exit",                                              0 },
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Terminal State Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
int
tst_vt320_report_presentation(const char*)
{
  /* *INDENT-OFF* */
  static MENU my_menu[] = {
      { "Exit",                                              0 },
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Presentation State Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
...
tst_vt320_reports(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_PageFormat(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("Page Format Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320_screen(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Screen-Display Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt320(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT320 Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
