...
tst_vt520_cursor(const char* the_title)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Cursor-Movement"));
...
tst_VT520_hardware_DECRQSS(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Status-Strings Reports (Hardware-oriented)"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_VT520_DECRQSS(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Status-Strings Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_VT520_report_presentation(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Presentation State Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
...
tst_vt520_reports(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Reports"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt520_screen(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Screen-Display Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
...
tst_vt520(const char*)
{
  ...
  do {
    ed(2);
    __(title(0), cb_printf("VT520 Tests"));
    __(title(2), println("Choose test type:"));
  } while (menu(my_menu));
  return MENU_NOHOLD;
}
