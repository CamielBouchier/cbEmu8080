...
File.open("cb_VtParserTables.h", "w") { |f|
    f.puts
...
puts "Wrote cb_VtParserTables.h"

File.open("cb_VtParserTables.cpp", "w") { |f|
    f.puts
    f.puts '#include "cb_VtParserTables.h"'
    f.puts
...
puts "Wrote cb_VtParserTables.cpp"
