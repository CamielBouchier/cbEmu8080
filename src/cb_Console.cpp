...
#include "cb_Vt220CharRom.h"
#include "cb_VtParserTables.h"
...
cb_Console::cb_Console()
    ...
    // No point in moving to cb_Emu. Source and Target are here.
    connect(this, &cb_Console::SignalWrite, this, &cb_Console::Write);
    // connect(this, &cb_Console::SignalRead,  this, &cb_Console::Read);
...
void cb_Console::CreateVt220Glyphs() {
...
void cb_Console::CreateHostGlyphs() {
...
void cb_Console::Reset(const bool Hard) 
    {
    ...
    if (Hard) 
        ...
        CB_CALLOC(m_Cells,cb_ScreenCell*,m_NrRows*m_NrCols,sizeof(cb_ScreenCell));
        CB_CALLOC(m_TabStops,bool*,m_NrCols,sizeof(bool));
        CB_CALLOC(m_DWDHs,cb_DWDH*,m_NrRows,sizeof(cb_DWDH));
...
void cb_Console::GenerateReply(const char* Reply) 
    {
...
void cb_Console::GenerateCsiReply(const char* Reply) {
...
uint8_t cb_Console::Read(const uint8_t Address) 
    {
...
void cb_Console::Write(const uint8_t Address, const uint8_t Char) 
    {
    if (QThread::currentThread() != qApp->thread())
        {
...
void cb_Console::VtParserDoAction(const int Action, const uint8_t Char) {
...
void cb_Console::VtParserDoStateChange(const uint8_t Change, const uint8_t Char) {
...
void cb_Console::VtParse(const uint8_t Char) {
...
void cb_Console::VtParserCallback(const int Action, const uint8_t Char) {
...
void cb_Console::VtParserShowResult() {
...
void cb_Console::VtHookCommand(const uint8_t Char) {
...
void cb_Console::VtPutCommand(const uint8_t Char) {
  if (m_VtParserDCSFinalChar == '|') {
...
void cb_Console::VtUnHookCommand(const uint8_t Char) {
  if (m_VtParserDCSFinalChar == '|') {
    VtDECUDK();
  } else if (m_VtParserDCSFinalChar == '!') {
    VtDECAUPSS(); 
...
void cb_Console::VtPutChar(const uint8_t Char) {
...
void cb_Console::VtExecute(const uint8_t Char) 
    {
    /*
    qDebug("%s@%s:%d Char : %02X ('%c')",
           __PRETTY_FUNCTION__, CB_BASENAME(__FILE__), __LINE__,
    ...
    */
    ...
    switch(Char) 
        ...
        case 0X05 : GenerateReply(C_STRING(cb_emu_8080::ProgramName));    break; // ENQ
...
void cb_Console::VtCsiCommand(const uint8_t Char) {
...
void cb_Console::VtEscCommand(const uint8_t Char) {
...
void cb_Console::VtANSICL(const uint8_t Char) {
  qDebug("ANSI Conformance Levels (%c) is currently NOP",Char);
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtBS() {
  if (m_CursorCol > 0) {
...
void cb_Console::VtCR() {
  m_CursorCol = 0;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::ClampCursor() {
...
void cb_Console::VtDECAUPSS() {
  qDebug("DECAUPSS is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECBI() {
  qDebug("DECBI is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECCARA() {
  qDebug("DECCARA is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECDHL(const bool Bottom) {
...
void cb_Console::VtDECKPAM() {
  m_KeypadNumeric = false;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECKPNM() {
  m_KeypadNumeric = true;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECLL() {
  qDebug("DECLL is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECRC() {
...
void cb_Console::VtDECSED() {
  EraseInDisplay(true);
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECSEL() {
  EraseInLine(true);
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECSLRM() {
  qDebug("DECSLRM is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECSTBM() {
...
void cb_Console::VtDECTST() {
  qDebug("Powerup test is currently NOP");
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtDECUDK() {
...
void cb_Console::EraseInDisplay(const bool Selective) {
  DEFAULT_0(Command);
  int StartRow;
  int StartCol;
  int EndRow;
...
void cb_Console::VtEL() {
  EraseInLine(false);
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtHPA() {
  DEFAULT_1(N);
  m_CursorCol  = N - 1;
  ClampCursor();
}
...
void cb_Console::EraseInLine(const bool Selective) {
  DEFAULT_0(Command);
  int Start;
  int End;
  switch (Command) {
...
void cb_Console::VtHTS() {
  m_TabStops[m_CursorCol] = true;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtHVP() {
  VtCUP(); // HVP seems older version of CUP.
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtICH() {
  DEFAULT_1(N);
  int Offset = m_CursorRow * m_NrCols;
...
void cb_Console::VtIND() {
  LineDown();
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtLF() {
  LineDown();
  if (m_LNM) {
    m_CursorCol = 0;
  }
...
void cb_Console::VtLS1R() {
  m_GR = 1;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtLS2() {
  m_GL = 2;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtLS2R() {
  m_GR = 2;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtLS3() {
  m_GL = 3;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtLS3R() {
  m_GR = 3;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtMode(const bool Set) {
...
void cb_Console::VtRI() {
  LineUp();
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::VtRIS() {
  // XXX CB TODO
...
void cb_Console::VtSCS(const int Set, const uint8_t Char) {
  QByteArray Name;
...
void cb_Console::Vt52DCA(const uint8_t Char) {
...
void cb_Console::Vt52ESA() {
  m_VT52_SSA = false;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::Vt52Home() {
  m_CursorRow = 0;
  m_CursorCol = 0;
}
...
void cb_Console::Vt52RI() {
  LineUp();
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::Vt52SSA() {
  m_VT52_SSA = true;
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void cb_Console::PaintScreen(QWidget* TheWidget) {
...
bool cb_Console::eventFilter(QObject* Object,  QEvent* Event) 
    {
...
void cb_Console::OnSizeChange(const int NrRows, const int NrCols) 
    {
    m_NrRows = NrRows;
    m_NrCols = NrCols;
...
void cb_Console::OnFontModeVt220Changed(const int Check) {
...
void cb_Console::OnBlankInterlineChanged(const int Check) {
...
void cb_Console::OnIntensityChanged(const int Value) 
    {
    m_Intensity = Value;
...
void cb_Console::OnUnderlineRowChanged(const int Check) {
...
void cb_Console::OnUpdateConsole() 
    {
...
void cb_Console::OnColorSchemeChanged(const int Scheme) 
    {
...
void vttest(cb_Console* Console);

void cb_Console::OnTest() {
...
uint16_t cb_Console::ToCellChar(const uint8_t Byte) {
...
void cb_Console::CreateHardCharSets() {
...
const uint16_t cb_Console::c_Uni16Maps[c_NrHardCharSets][c_NrCharsPerSet] = {
